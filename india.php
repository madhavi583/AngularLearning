...
$sql1 = "SELECT tblcity.Name,tblcountry.Name, tblcountry.Name, tblcity.Name FROM tblcity , tblcountry WHERE tblcity.CountryId =tblcountry.Id AND tblcountry.Name='India'";
